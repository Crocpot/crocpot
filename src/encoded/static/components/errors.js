    ...
    return (
        <div className={itemClass}>
            <div className="row">
                <div className="col-sm-12">
                    <h2>Our Apologies!</h2>
                    <p>The email address you have provided us does not match any user of the CROCPOT.</p>
                    <p>As you know, we have recently changed our login system.</p>

                    <p>The CROCPOT now uses a variety of common identity providers to verify you are who say you are.<br />
                    ...
                    <p><a href="https://ucsd.edu/about/terms-of-use.html">Terms and Conditions</a></p>
                </div>
            </div>
        </div>
    );
