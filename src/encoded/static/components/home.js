    ...
    render() {
        ...
        return (
            <div className="whole-page">
		        ...
		        <h2>CROCPOT</h2>
                        <p><h7>CROCPOT is a repository of epigenomic datasets linking distal cis-regulatory elements to their putative target genes including 3D chromatin interactions, single cell co-activity, activity-by-contact (ABC) and CRISPRi regulatory screens. Furthermore, links between distal sites and gene promoters can be visualized on a genome browser along with molecular QTL and genome-wide association data.  These data and associated genome browser should together help facilitate the prioritization of target genes of non-coding genetic variants associated with complex disease.</h7></p>
                        <p><h7>This project is funded by the NIDDK, FNIH, and the AMP-CMD consortium.</h7></p>
                        <a className="btn-lg btn-tools" target = "_blank" href = { 'http://www.tools.cmdga.org/tracks/tracks.html' } style= {{ 'font-size': '17px', 'word-break': 'break-word', 'display': '-webkit-inline-box',  'justify-content': 'center', 'text-align': 'center', 'align-items': 'center', 'font-family': 'Helvetica Neue,Helvetica,Arial,sans-serif', 'margin-top': '5px'}} title="tracks">LOAD TRACKS</a>
                        </div>
                        </div>
                        </div>
                        </div>
